            ...
            if ($params['recent']) {
                foreach ($params['recent'] as $message) {
                    ...
                    <div class="user-item <?php echo $new; ?>" 
                        ...
                        <div class="image"><img
                                src="<?php echo ossn_site_url(); ?>avatar/<?php echo $user->username; ?>/small" width="50" height="50"/></div>
                        <div class="data">
            ...
            if ($params['data']) {
                foreach ($params['data'] as $message) {
                    ...
                    <div class="message-item">
                        <img src="<?php echo ossn_site_url(); ?>avatar/<?php echo $user->username; ?>/smaller" width="32" height="32"/>
