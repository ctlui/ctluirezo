...
.activity-item-container .owner img {
border-radius : 3px;
...
.ossn-wall-post-controls:hover .post-menu .menu-links {
border : #2f4959 solid 1px;
width : 200px;
margin-left : -183px;
margin-top : 5px;
