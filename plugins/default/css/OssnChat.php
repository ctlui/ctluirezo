...
border : #2F4959 solid 1px !important ;
color : #fff;
}
...
.friend-tab-item .data .message-reciever .text, .friend-tab-item .data .message-sender .text {
position : relative;
margin-top : 5px;
margin-bottom : 5px;
max-width : 80%;
...
.ossn-chat-icon, .ossn-chat-icon-online, .ossn-chat-icon-offline, .ossn-chat-icon-expend, .ossn-chat-icon-smile {
...
.ossn-chat-windows-long .friends-list-item .icon img {
border-radius : 3px;
}
...
.ossn-chat-windows-long .friends-list-item:hover .name {
color : #2f4959;
}
...
background:url('<?php echo ossn_theme_url(); ?>images/OssnChat/loading-small.gif') no-repeat;	
width : 16px;
height : 11px;
}