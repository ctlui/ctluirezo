...
?>
<a title="<?php echo $user->username;?>" class="front-member-item" href="http://localhost/ossn/u/<?php echo $user->username;?>?ref=ossntb"><img width="50" height="50" alt="Profile picture of Michael" class="avatar user-1-avatar avatar-60 photo" src="<?php echo $user->iconURL()->small;?>"></a>
